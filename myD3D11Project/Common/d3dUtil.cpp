...
ID3D11ShaderResourceView* d3dHelper::CreateRandomTexture1DSRV(ID3D11Device* device)
{
	...
	{
		randomValues[i].x = myMathLibrary::Random(-1.0f, 1.0f);
		randomValues[i].y = myMathLibrary::Random(-1.0f, 1.0f);
		randomValues[i].z = myMathLibrary::Random(-1.0f, 1.0f);
		randomValues[i].w = myMathLibrary::Random(-1.0f, 1.0f);
	}
